...
gpu_test(
    gpu_arr, # bool *arr
    np.uint64(shape_0), # unsigned long long shape_0
    np.uint64(shape_1), # unsigned long long shape_1
    np.uint64(shape_2), # unsigned long long shape_2
    np.uint64(multiplier), # unsigned long long multiplier
...
# Save as obj
print('Saving as obj...')
mcubes.export_obj(vertices, triangles, '../data/loop_unrolling.obj')
